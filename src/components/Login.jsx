    ...
    <div className="min-h-screen bg-[#101820] text-[#EDE7DA] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="flex items-center gap-2 mb-8 justify-center">
          ...
          <div>
            <div className="font-mono text-[11px] tracking-[0.2em] text-[#8FA6AE] uppercase">Timesheet Co.</div>
            <div className="font-semibold text-lg leading-none">Attendance Ledger</div>
          </div>
        </div>
          ...
          {step === "email" ? (
            <>
              <p className="text-[13px] text-[#8FA6AE] mb-4">
                Enter your work email — we'll send you a one-time sign-in code. New here? Add your name too.
              </p>
              <label className="block text-[11px] uppercase tracking-wide text-[#8FA6AE] mb-1">Work email</label>
              <input
                type="email"
                value={email}
              ...
              <label className="block text-[11px] uppercase tracking-wide text-[#8FA6AE] mb-1">
                Full name <span className="normal-case text-[#5B6B73]">(only needed first time)</span>
              </label>
              <input
                value={name}
              ...
              />
              {err && <p className="text-[12px] text-[#E08D6D] mb-3 flex items-center gap-1"><AlertCircle size={13} />{err}</p>}
              <button
            ...
            <>
              <button onClick={() => setStep("email")} className="flex items-center gap-1 text-[12px] text-[#8FA6AE] mb-4 hover:text-[#EDE7DA]">
                <ArrowLeft size={13} /> Use a different email
              </button>
              <p className="text-[13px] text-[#8FA6AE] mb-4">
                Enter the 6-digit code sent to <span className="text-[#EDE7DA]">{email}</span>.
              </p>
              <input
                value={code}
